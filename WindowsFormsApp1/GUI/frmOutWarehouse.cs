...
{
    public partial class frmOutWarehouse : Form
    {
        public frmOutWarehouse()
        {
            InitializeComponent();
        }
        ...
        {
            DialogResult result = MessageBox.Show("Xuất thành công.", "Thông báo",MessageBoxButtons.OK,MessageBoxIcon.Information);
